...
<head>
	...
	<title>Ribshack | Conversion</title>
...
<div class="wrapper">
	...
	<div class="content-wrapper">
      ...
      <span class="pull-right">
        <button type="button" class="btn btn-info" id="new_conversion_btn"><i class="fa fa-plus"></i>&nbsp; Add Conversion</button>
      </span>
	...
	<!-- modal [new product] -->
	<div class="modal fade" id="new_conversion_modal" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog" role="document">
            ...
            border: 1px solid #008d4c; background-color: #00a65a; color: #FFF";
							class="fa fa-sliders"></span> &nbsp; <b>New Conversion</b></h4>
				</div>
				<div class="modal-body">
					<form role="form" id="newConversionForm">
						<div class="box-body">
							<div class="form-group">
								<label>Product</label>
								<select class="select2 js-states form-control" id="product_code">
								</select>
							</div>

							<div class="form-group">
								<label>Raw Material</label>
								<select class="select2 js-states form-control" id="raw_material">
								</select>
							</div>

							<div class="form-group">
								<label for="uom_abbr">Conversion</label>
	...
	<div class="modal fade" id="conversion_detail_modal" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<h4 class="modal-title"><span
							style="border-radius: 2px; padding: 6px;
            border: 1px solid #008d4c; background-color: #00a65a; color: #FFF";
							class="fa fa-sliders"></span> &nbsp; <b>Conversion Detail</b></h4>
				</div>
				<div class="modal-body">
					<form role="form" id="detailRMForm">
						<div class="box-body">
							<div class="form-group">
								<label>Product</label>
								<select class="select2 js-states form-control" id="update_product_code">
								</select>
							</div>

							<div class="form-group">
								<label>Raw Material</label>
								<select class="select2 js-states form-control" id="update_raw_material">
								</select>
							</div>

							<div class="form-group">
								<label for="uom_abbr">Conversion</label>
								<input type="text" class="form-control" id="update_conversion">
							</div>
						</div>
					</form>
				</div><!-- body -->
				<div class="modal-footer">
					<div id="footer">
						<div class="btn-group btn-group-justified" id="form-mode-buttons" role="group" >
							<button type="button" id="delete_conversion" class="btn btn-danger" style="width:49%">
								<i class="fa fa-trash-o"></i>&nbsp; Delete
							</button>
							<button type="button" id="updateConversion_submitBtn" class="btn btn-primary" data-key-method="ok" style="width:49%">
								<i class="fa fa-save"></i>&nbsp; Save
							</button>
						</div>
					</div>
				...
				<div class="modal-footer">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<a href="#" class="btn btn-danger" id="confirm_delete_conversion_btn">Delete</a>
						</div>
					</div>
				</div>
			</div>
...
<script src="<?php echo base_url(); ?>assets/dist/js/conversion.js"></script>
